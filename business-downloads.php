...
<head>
    ...
    <style>
        ...
        .business-badge { background: var(--accent-color); color: white; padding: 0.25rem 0.75rem; border-radius: 20px; font-size: 0.8rem; font-weight: 600; display: inline-block; margin-bottom: 1rem; }
        .download-card { background: white; border-radius: 16px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1); border: none; padding: 2rem; margin-bottom: 2rem; transition: all 0.3s ease; }
        .download-card:hover { transform: translateY(-5px); box-shadow: 0 20px 25px -5px rgba(0, 0, 0, 0.1); }
        .download-card .card-title { color: var(--primary-color); font-weight: 600; }
        .download-card .card-text { color: var(--dark-text); }
        .download-btn { background: linear-gradient(135deg, var(--primary-color), var(--secondary-color)); border: none; padding: 0.75rem 1.5rem; border-radius: 8px; color: white; text-decoration: none; display: inline-block; transition: all 0.3s ease; }
        .download-btn:hover { transform: translateY(-2px); box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.1); color: white; }
        .file-info { background: #f1f5f9; padding: 1rem; border-radius: 8px; margin-top: 1rem; }
        .file-info .bi { color: var(--primary-color); margin-right: 0.5rem; }
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item" id="businessDownloadsLink" style="display: none;"><a class="nav-link active" href="business-downloads.php">Business Downloads</a></li>
        ...
        <div class="row">
            <div class="col-md-10 mx-auto">
                <div class="download-card">
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            ...
                            <p class="card-text">Umfassende technische Dokumentation für die Integration und Administration von BookIT-Systemen.</p>
                            <div class="file-info">
                ...
                <div class="download-card">
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            ...
                            <p class="card-text">Vollständige API-Dokumentation mit Beispielen für die Integration in bestehende Systeme.</p>
                            <div class="file-info">
                ...
                <div class="download-card">
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            <h5 class="card-title"><i class="bi bi-file-earmark-word"></i> Implementierungsleitfaden</h5>
                            <p class="card-text">Schritt-für-Schritt Anleitung für die erfolgreiche Implementierung von BookIT in Unternehmen.</p>
                            <div class="file-info">
                ...
                <div class="download-card">
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            <h5 class="card-title"><i class="bi bi-file-earmark-presentation"></i> Präsentationsmaterialien</h5>
                            <p class="card-text">Professionelle Präsentationsvorlagen und Marketing-Materialien für Partner und Kunden.</p>
                            <div class="file-info">
                ...
                <div class="download-card">
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            ...
                            <p class="card-text">Umfassende Sicherheitsrichtlinien und Best Practices für den Betrieb von BookIT-Systemen.</p>
                            <div class="file-info">
