    ...
    <ul class="bk-nav__links">
      ...
      <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu">
          <li>
            <a class="dropdown-item" href="/customer-news.php">
...
<style>
  ...
  /* Open state */
  .bk-nav__hamburger.is-open span:nth-child(1) {
    transform: translateY(7px) rotate(45deg);
  }

  .bk-nav__hamburger.is-open span:nth-child(2) {
    opacity: 0;
    transform: scaleX(0);
  }

  .bk-nav__hamburger.is-open span:nth-child(3) {
    transform: translateY(-7px) rotate(-45deg);
  }
  ...
  @media (max-width: 768px) {
    ...
    /* shown/hidden via JS class below */
    .bk-nav__drawer:not(.is-open) {
      display: none;
    }
  }
</style>
