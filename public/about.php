...
<body>
    ...
    <div class="container my-5 fade-in">
        <h2>Über BookIT</h2>
        <p>BookIT wurde 2026 in Berlin, Deutschland, gegründet. Unser Ziel ist es, Raumverwaltung für Unternehmen und
            Organisationen zu vereinfachen. Mit einem Team von erfahrenen Entwicklern und UX-Designern bieten wir
            innovative Lösungen für moderne Arbeitsumgebungen.</p>
        ...
        <h4>Warum BookIT?</h4>
        <p>Wir glauben an benutzerfreundliche Technologie, die den Alltag erleichtert. Neben unserer Buchungssoftware
            bieten wir auf Anfrage komplette Website-Entwicklung und Server-Hosting an, um Ihre digitale Präsenz zu
            optimieren.</p>
    </div>
    ...
    <footer>
        <div class="container">
            <p>&copy; 2026 BookIT. Alle Rechte vorbehalten. | <a href="about.php">About Us</a> | <a
                    href="impressum.php">Impressum</a> | <a href="index.php#contact">Kontakt</a></p>
        </div>
    </footer>
